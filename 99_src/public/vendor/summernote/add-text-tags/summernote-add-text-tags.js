        ...
        'add-text-tags': function (context) {
            ...
            self.generateBtn = function(tag, tooltip) {
                ...
                return ui.button({
                    ...
                    //tooltip: tooltip + ' <' + tag + '>',
                    className: 'note-add-text-tags-btn add-text-tags-subbtn type-' + tag,
                    click: function (e) {
                        self.wrapInTag(tag);
                    }
                });
            ...
            self.customGenerateBtn = function(tag, tooltip, tagInfo) {
                return ui.button({
                    contents: '<span>'+tagInfo.view+'</span>',
                    className: 'note-add-text-tags-btn add-text-tags-subbtn type-' + tagInfo.type,
                    click: function (e) {
                        self.wrapInTag(tag, tagInfo);
                    }
                });
            };
            ...
            var cap = self.customGenerateBtn('p', 'First letter large', {view: 'C', className: 'lead drop-cap', type: 'cap'});


            context.memo('button.add-text-tags', function () {
                return ui.buttonGroup([
                    ui.button({
                        className: 'dropdown-toggle add-text-tags',
            ...
            self.wrapInTag = function (tag, tagInfo) {
                ...
                if (window.getSelection) {
                    ...
                    if (selected.startOffset !== selected.endOffset) {
                        ...
                        if(typeof tagInfo != 'undefined') {
                            newNode.className = tagInfo.className;
                        }
